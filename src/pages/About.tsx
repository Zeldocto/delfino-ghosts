  ...
  return (
    <div className="page">
      ...
      <div className="prose" style={{ marginTop: 16 }}>
        ...
        <h2>TAS</h2>
        <p>
          A ghost marked TAS was produced with tool assistance; frame advance, rather than played in one sitting by hand. Neither is better than the other, but they
